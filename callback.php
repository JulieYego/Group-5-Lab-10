...
$accesstoken = '';
$max_results = 500;
$client_id = '1067667438304-8e5hqhvjnd0r51jd6rrtofh1buenkup4.apps.googleusercontent.com';
$client_secret = 'Vpn9gTMgWKxXDZkF7srL8Boq';
$redirect_uri = 'http://localhost/gmailcontact/callback.php';
$simple_api_key = 'AIzaSyBGt6GbU8lcCBiTOokms2MCNTs4wQEEzQE';
$auth_code = $_GET["code"];
...
//$xml = new SimpleXMLElement($xmlresponse,null,true);
...
Export Gmail Contacts<a href='https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://www.tutorialswebsite.com/index.php' >Logout</a></h2>
</header>
<hr>
<div class="col-sm-6 col-md-4 col-lg-2">
<div class="col-sm-6 col-md-4 col-lg-2">
